...
public class ReporteController {
     ...
     * @param estadoVisita  Filtro por estado de visita (PAGO_COMPLETO, NO_PAGO,
     *                      etc.)
    ...
    public ResponseEntity<ReportePaginadoResponse> obtenerReportes(
        ...
        logger.info(
                ...
                ccCliente, nombreCliente, tipoUsuario, estadoVisita, novedadId, fechaDesde, fechaHasta, page, size);
